...
export const instrumentSummary: SummaryRow[] = [
  { label: "EURUSD", netProfit: 2271.84, winRate: 68, totalProfits: 4964.36, totalLoss: 2692.52, trades: 19, volume: 68 },
  { label: "GBPUSD", netProfit: 2025.73, winRate: 72, totalProfits: 4180.67, totalLoss: 2154.94, trades: 6, volume: 15 },
  { label: "USDCAD", netProfit: 1658.71, winRate: 85, totalProfits: 1658.71, totalLoss: 0, trades: 1, volume: 1 },
  { label: "AUDUSD", netProfit: -1024.34, winRate: 35, totalProfits: 560.45, totalLoss: 1584.79, trades: 4, volume: 14 },
];

export const durationSummary: SummaryRow[] = [
  { label: "Under 1 min", netProfit: 0, winRate: 0, totalProfits: 0, totalLoss: 0, trades: 0, volume: 0 },
  { label: "1:00 to 1:59", netProfit: 0, winRate: 0, totalProfits: 0, totalLoss: 0, trades: 0, volume: 0 },
  { label: "2:00 to 4:59", netProfit: 0, winRate: 0, totalProfits: 0, totalLoss: 0, trades: 0, volume: 0 },
  { label: "5:00 to 9:59", netProfit: -110.27, winRate: 0, totalProfits: 0, totalLoss: 110.27, trades: 1, volume: 1 },
  { label: "10:00 to 29:59", netProfit: -1850.45, winRate: 25, totalProfits: 450.20, totalLoss: 2300.65, trades: 3, volume: 8 },
];
...
export function getDataForCategory(category: FilterCategory): TradeData[] {
  switch (category) {
    case "days":
      return dayDistributionData;
    case "weeks":
      return weekDistributionData;
    case "months":
      return monthDistributionData;
    case "time":
    ...
    case "instrument":
      return instrumentDistributionData;
    case "sector":
      return sectorDistributionData;
    case "setups":
      return setupDistributionData;
    case "mistakes":
      return mistakeDistributionData;
    case "tags":
      return tagDistributionData;
    default:
      return timeDistributionData;
  }
}
